...
class TopModel extends AbstractTableModel {
	...
	void addRow( NewContract contract) {
		...
		m_rows.add( row);
		com.ib.apidemo.ApiDemo.INSTANCE.controller().reqTopMktData(contract, "", false, row);
	...
	public void desubscribe() {
		for (TopRow row : m_rows) {
			com.ib.apidemo.ApiDemo.INSTANCE.controller().cancelTopMktData( row);
		}
	}		
	...
	public void cancel(int i) {
		com.ib.apidemo.ApiDemo.INSTANCE.controller().cancelTopMktData( m_rows.get( i) );
	}

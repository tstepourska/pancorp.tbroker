...
public class OrdersPanel extends JPanel {
	...
	protected void onTakeOverExisting() {
		com.ib.apidemo.ApiDemo.INSTANCE.controller().takeTwsOrders( m_model);
	}

	protected void onTakeOverFuture() {
		com.ib.apidemo.ApiDemo.INSTANCE.controller().takeFutureTwsOrders( m_model);
	}

	protected void onCancel() {
		OrderRow order = getSelectedOrder();
		if (order != null) {
			com.ib.apidemo.ApiDemo.INSTANCE.controller().cancelOrder( order.m_order.orderId() );
		}
	}

	protected void onCancelAll() {
		com.ib.apidemo.ApiDemo.INSTANCE.controller().cancelAllOrders();
	}
	...
	protected void onRefresh() {
		...
		com.ib.apidemo.ApiDemo.INSTANCE.controller().reqLiveOrders( m_model);
	}

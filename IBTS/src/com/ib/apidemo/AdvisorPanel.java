...
public class AdvisorPanel extends NewTabPanel implements IAdvisorHandler {
	...
	@Override public void activated() {
		com.ib.apidemo.ApiDemo.INSTANCE.controller().reqAdvisorData( FADataType.GROUPS, this);
		com.ib.apidemo.ApiDemo.INSTANCE.controller().reqAdvisorData( FADataType.PROFILES, this );
		com.ib.apidemo.ApiDemo.INSTANCE.controller().reqAdvisorData( FADataType.ALIASES, this );
	}
	...
	private static class GroupModel extends AbstractTableModel {
		...
		public void transmit() {
			com.ib.apidemo.ApiDemo.INSTANCE.controller().updateGroups(m_groups);
		}
	...
	private static class ProfileModel extends AbstractTableModel {
		...
		public void transmit() {
			com.ib.apidemo.ApiDemo.INSTANCE.controller().updateProfiles( m_profiles);
		}

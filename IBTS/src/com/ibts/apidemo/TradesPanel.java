...
import com.ibts.client.ExecutionFilter;
import com.ibts.controller.NewContract;
import com.ibts.controller.ApiController.ITradeReportHandler;
...
public class TradesPanel extends JPanel implements ITradeReportHandler {
	...
	private void onRefresh() {
		com.ibts.apidemo.ApiDemo.INSTANCE.controller().reqExecutions( new ExecutionFilter(), this);
	}

...
import com.ibts.apidemo.util.VerticalPanel.BorderPanel;
...
public class StratPanel extends StackPanel implements IHistoricalDataHandler, IRealTimeBarHandler {
	...
	protected void onStart() {
		...
		com.ibts.apidemo.ApiDemo.INSTANCE.controller().reqRealTimeBars(m_contract, WhatToShow.TRADES, false, this);
	}
	...
	@Override public void realtimeBar(Bar bar) {
		if (!m_req) {
			...
			com.ibts.apidemo.ApiDemo.INSTANCE.controller().reqHistoricalData(m_contract, date, duration, queryLength.m_unit, barSize, WhatToShow.TRADES, false, this);
			m_req = true;
		}
		addBar( bar);
		m_chart.repaint();

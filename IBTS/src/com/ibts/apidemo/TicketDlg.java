...
package com.ibts.apidemo;

import static com.ibts.controller.Formats.fmt;
...
import com.ibts.apidemo.util.Util;
import com.ibts.apidemo.util.VerticalPanel;
import com.ibts.apidemo.util.VerticalPanel.HorzPanel;
...
import com.ibts.controller.NewOrderState;
import com.ibts.controller.OrderStatus;
import com.ibts.controller.OrderType;
import com.ibts.controller.Types.Action;
import com.ibts.controller.Types.AlgoParam;
import com.ibts.controller.Types.AlgoStrategy;
import com.ibts.controller.Types.ComboParam;
import com.ibts.controller.Types.HedgeType;
import com.ibts.controller.Types.Method;
import com.ibts.controller.Types.OcaType;
import com.ibts.controller.Types.ReferencePriceType;
import com.ibts.controller.Types.Rule80A;
import com.ibts.controller.Types.TimeInForce;
import com.ibts.controller.Types.TriggerMethod;
import com.ibts.controller.Types.VolatilityType;
...
public class TicketDlg extends JDialog {
	...
	public TicketDlg(NewContract contract, NewOrder order) {
		super( com.ibts.apidemo.ApiDemo.INSTANCE.frame());
	...
	protected void onTransmitOrder() {
		...
		com.ibts.apidemo.ApiDemo.INSTANCE.controller().placeOrModifyOrder( m_contract, m_order, new IOrderHandler() {
			@Override public void orderState(NewOrderState orderState) {
				com.ibts.apidemo.ApiDemo.INSTANCE.controller().removeOrderHandler( this);
	...
	class OrderPanel extends VerticalPanel {
		final TCombo<String> m_account = new TCombo<String>( com.ibts.apidemo.ApiDemo.INSTANCE.accountList().toArray(new String[0]) );
		...
		OrderPanel() {
			...
			m_account.setSelectedItem( m_order.account() != null ? m_order.account() : com.ibts.apidemo.ApiDemo.INSTANCE.accountList().get( 0) ); 

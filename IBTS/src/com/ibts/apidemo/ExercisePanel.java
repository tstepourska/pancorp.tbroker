...
import com.ibts.apidemo.AccountInfoPanel.PortfolioModel;
...
import com.ibts.controller.Position;
import com.ibts.controller.ApiController.IAccountHandler;
import com.ibts.controller.Types.ExerciseType;
...
public class ExercisePanel extends HorzPanel implements INewTab, IAccountHandler {
	...
	protected void onAcctChanged() {
		...
		if (i != -1) {
			...
			if (!selAcct.equals( m_selAcct) ) {
				...
				com.ibts.apidemo.ApiDemo.INSTANCE.controller().reqAccountUpdates(true, m_selAcct, this);
			}
		}
	}
	...
	class ExPanel extends VerticalPanel {
		...
		protected void onExercise() {
			...
			if (i != -1 && account != null) {
				...
				com.ibts.apidemo.ApiDemo.INSTANCE.controller().exerciseOption(account, position.contract(), m_combo.getSelectedItem(), m_qty.getInt(), m_override.isSelected() );
			}
		}
	}
	...
	@Override public void activated() {
		for (String account : com.ibts.apidemo.ApiDemo.INSTANCE.accountList() ) {

...
public class AccountSummaryPanel extends NewTabPanel {
	...
	private void subscribe() {
		com.ibts.apidemo.ApiDemo.INSTANCE.controller().reqAccountSummary( "All", AccountSummaryTag.values(), m_model); 
	}
	
	private void desubscribe() {
		com.ibts.apidemo.ApiDemo.INSTANCE.controller().cancelAccountSummary( m_model);
		m_model.clear();
	}
	...
	private class SummaryModel extends AbstractTableModel implements IAccountSummaryHandler {
		...
		public void clear() {
			com.ibts.apidemo.ApiDemo.INSTANCE.controller().cancelAccountSummary( this);
			m_rows.clear();
			m_map.clear();
			m_complete = false;

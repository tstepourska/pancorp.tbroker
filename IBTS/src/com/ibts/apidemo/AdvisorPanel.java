...
import com.ibts.controller.Alias;
import com.ibts.controller.Group;
import com.ibts.controller.Profile;
import com.ibts.controller.ApiController.IAdvisorHandler;
import com.ibts.controller.Profile.Type;
import com.ibts.controller.Types.FADataType;
...
public class AdvisorPanel extends NewTabPanel implements IAdvisorHandler {
	...
	@Override public void activated() {
		com.ibts.apidemo.ApiDemo.INSTANCE.controller().reqAdvisorData( FADataType.GROUPS, this);
		com.ibts.apidemo.ApiDemo.INSTANCE.controller().reqAdvisorData( FADataType.PROFILES, this );
		com.ibts.apidemo.ApiDemo.INSTANCE.controller().reqAdvisorData( FADataType.ALIASES, this );
	}
	...
	private static class GroupModel extends AbstractTableModel {
		...
		public void transmit() {
			com.ibts.apidemo.ApiDemo.INSTANCE.controller().updateGroups(m_groups);
		}
	...
	private static class ProfileModel extends AbstractTableModel {
		...
		public void transmit() {
			com.ibts.apidemo.ApiDemo.INSTANCE.controller().updateProfiles( m_profiles);
		}

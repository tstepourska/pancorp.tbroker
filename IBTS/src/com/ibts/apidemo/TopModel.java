...
import static com.ibts.controller.Formats.*;
...
class TopModel extends AbstractTableModel {
	...
	void addRow( NewContract contract) {
		...
		m_rows.add( row);
		com.ibts.apidemo.ApiDemo.INSTANCE.controller().reqTopMktData(contract, "", false, row);
	...
	public void desubscribe() {
		for (TopRow row : m_rows) {
			com.ibts.apidemo.ApiDemo.INSTANCE.controller().cancelTopMktData( row);
		}
	}		
	...
	public void cancel(int i) {
		com.ibts.apidemo.ApiDemo.INSTANCE.controller().cancelTopMktData( m_rows.get( i) );
	}

...
import com.ibts.controller.ApiController.IPositionHandler;
...
public class PositionsPanel extends NewTabPanel {
	...
	private void subscribe() {
		com.ibts.apidemo.ApiDemo.INSTANCE.controller().reqPositions( m_model);
	}
	
	private void desubscribe() {
		com.ibts.apidemo.ApiDemo.INSTANCE.controller().cancelPositions( m_model);
		m_model.clear();
	}

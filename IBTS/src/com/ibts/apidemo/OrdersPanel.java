...
import com.ibts.controller.ApiController.ILiveOrderHandler;
...
public class OrdersPanel extends JPanel {
	...
	protected void onTakeOverExisting() {
		com.ibts.apidemo.ApiDemo.INSTANCE.controller().takeTwsOrders( m_model);
	}

	protected void onTakeOverFuture() {
		com.ibts.apidemo.ApiDemo.INSTANCE.controller().takeFutureTwsOrders( m_model);
	}

	protected void onCancel() {
		OrderRow order = getSelectedOrder();
		if (order != null) {
			com.ibts.apidemo.ApiDemo.INSTANCE.controller().cancelOrder( order.m_order.orderId() );
		}
	}

	protected void onCancelAll() {
		com.ibts.apidemo.ApiDemo.INSTANCE.controller().cancelAllOrders();
	}
	...
	protected void onRefresh() {
		...
		com.ibts.apidemo.ApiDemo.INSTANCE.controller().reqLiveOrders( m_model);
	}

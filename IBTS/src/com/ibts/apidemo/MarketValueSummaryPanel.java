...
import com.ibts.apidemo.AccountInfoPanel.MktValModel;
import com.ibts.apidemo.AccountInfoPanel.Table;
...
import com.ibts.controller.ApiController.IMarketValueSummaryHandler;
import com.ibts.controller.MarketValueTag;
...
public class MarketValueSummaryPanel extends NewTabPanel implements IMarketValueSummaryHandler {
	...
	private void subscribe() {
		com.ibts.apidemo.ApiDemo.INSTANCE.controller().reqMarketValueSummary( "All", this);
	}

	private void desubscribe() {
		com.ibts.apidemo.ApiDemo.INSTANCE.controller().cancelMarketValueSummary( this);
		m_model.clear();
	}
